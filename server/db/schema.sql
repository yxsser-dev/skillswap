...
-- Listings Table (Offered or Sought Skills)
...
-- ==========================================
-- SEED DATA (Pre-populating Database)
-- ==========================================
...
-- Seed Users
-- The hashed password for all seed users is 'password123'
...
-- Seed Listings establishing a Mutual Swap Pair:
-- Alice teaches Spanish (1) & seeks React (2)
-- Bob teaches React (2) & seeks Spanish (1)
